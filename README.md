...
声明：本项目完全是由AI设计开发的。目前还没有经过实战测试。有兴趣的同学可以用来跑两个 demo 尝试。强烈建议不要用到生产项目中去。 

项目功能及源码正在不断完善中。

<br />

如果使用中遇到无法解决的问题可以在 github 上提bug。
...
import "github.com/goweb-framework/goweb"
...
```bash
go get github.com/goweb-framework/goweb
```
...
```go
import "github.com/goweb-framework/goweb/testutil"
